...
# Use file for common words. File from https://norvig.com/ngrams/count_1w.txt. Frequency has been stripped via sed -i 's/[0-9]*//g'
...
def word_is_eligible(word):
    ...
    with open(common_words_file, "r") as f:
        if word.lower() in f or word.lower() + "s" in f:
            return False
    # Not SANS url
